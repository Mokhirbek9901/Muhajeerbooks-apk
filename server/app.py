...
def admin_ai_book_research():
    ...
    try:
      ...
      allowed=("title","author","publisher","category","description","description_variants","page_count","cover","confidence","notes")

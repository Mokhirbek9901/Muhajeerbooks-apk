...
-- Eski permissive policy source='telegram' deb ko‘rsatib public insert qilishga yo‘l ochardi.
-- App uchun allaqachon alohida source='app' policy mavjud, shuning uchun uni olib tashlaymiz.
drop policy if exists orders_public_insert on public.orders;

-- INSERT ... RETURNING uchun ko‘rish faqat app buyurtmasiga cheklanadi.

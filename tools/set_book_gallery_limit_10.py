...
# Only limit NEW image uploads to 10. Existing books that already have more
# than 10 images are intentionally preserved so editing a book never deletes
# old gallery images.
...
print('New book-gallery uploads limited to 10 images; existing larger galleries preserved.')
